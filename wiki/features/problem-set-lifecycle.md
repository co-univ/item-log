...
- 2026-04-26 회의에서는 문제셋 삭제가 배포 항목으로 올라왔지만, 관련 데이터가 실제로 안 보이는지 확인해야 한다는 후속이 남았다. 2026-05-08 AI 후속 정리에서 이 보정 작업은 `MAIT-136`으로 새로 연결됐다. [2026-04-26 주간 회의록](../sources/2026-04-26-weekly-meeting.md)
