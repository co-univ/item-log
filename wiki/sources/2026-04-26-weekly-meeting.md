...
- 2026-05-08 AI 후속 정리에서 문제셋 삭제 후 관련 데이터 잔존 여부는 신규 Jira `MAIT-136`으로 만들었고, 학습모드·카테고리·GA4·개인 워크스페이스·알림은 기존 티켓에 연결했다. 근거: [raw/2026-04-26-weekly-meeting.md](../../raw/2026-04-26-weekly-meeting.md) `§7. 할일 티켓 정리`. 영향: [문제 셋 라이프사이클](../features/problem-set-lifecycle.md), [알림](../features/user-notifications.md)
