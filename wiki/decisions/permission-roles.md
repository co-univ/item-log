...
type: decision
status: draft
sources: [raw/2026-04-14-spec-team-member-and-category.md, raw/2026-04-30-spec-team-member-and-category.md, raw/2026-04-14-spec-problem-management.md, raw/2025-12-17-spec-problem-search.md, raw/2025-11-07-weekly-meeting.md, raw/2025-12-10-weekly-meeting.md, raw/2025-12-23-weekly-meeting.md, raw/2026-04-19-weekly-meeting.md, raw/2026-05-10-spec-personal-workspace.md]
updated: 2026-05-30
---
...
- 개인 워크스페이스는 maker에 해당하는 것으로 처리되어 항상 `문제 관리`로 이동한다.
- 팀 멤버 권한 전환 대상이 아니며 멤버관리는 비활성화된다.
- 이 예외는 팀 권한 3단계와 별도 컨텍스트로 봐야 한다.
...
- 2026-04-30 Confluence v7 명세에서도 owner는 maker 영역 하단에 별도 표시되고 삭제할 수 없으며, maker/player 권한 전환은 컬럼 사이 이동 버튼으로 처리한다. [2026-04-30 팀관리 명세서](../sources/2026-04-30-spec-team-member-and-category.md)
...
- 개인 워크스페이스의 maker 취급이 API 권한 코드에서 별도 role인지, 소유자 기반 컨텍스트인지
